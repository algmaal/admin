...
class Ion_auth_model extends CI_Model
{
	...
	**/
	...
	//DODATO
	//http://stackoverflow.com/questions/10734606/retrieve-the-group-id-of-user-in-ion-auth-codeigniter
	...
	public function get_all_users_with_group()
	{
	    ...
	    ->join($this->tables['groups'], $this->tables['users_groups'].'.'.$this->join['groups'].'='.$this->tables['groups'].'.id')->order_by('id', 'ASC')
	    ->get($this->tables['users']);
	}
}
